...
gdjs.evtsExt__Collectible__Collectible.Collectible = class Collectible extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData.RotationSpeed = behaviorData.RotationSpeed !== undefined ? behaviorData.RotationSpeed : Number("50") || 0;
  }
  ...
  _getRotationSpeed() {
    return this._behaviorData.RotationSpeed !== undefined ? this._behaviorData.RotationSpeed : Number("50") || 0;
  }
...
{
{gdjs.evtTools.sound.playSound(runtimeScene, "CoinPickUp", false, 25, eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0).getAsNumber());
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0).mul(1.05);
